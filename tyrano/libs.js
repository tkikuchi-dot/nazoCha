(function ($) {
    ...
    */
     ...
     * @param {string} storage "foo.webp"
     * @param {string} folder "image"
     * @returns {string}
     * @example
     * $.parseStorage("foo.webp", "image");
     * // "./data/image/foo.webp"
     * $.parseStorage("https://tyrano.jp/foo.webp", "image");
     * // "https://tyrano.jp/foo.webp"
     * $.parseStorage("nextpage.gif", "tyrano/images/system");
     * // "./tyrano/images/system/nextpage.gif"
     * $.parseStorage("foo.webp", "data/image");
     * // "./data/image/foo.webp"
     * $.parseStorage("../fgimage/foo.webp", "image");
     * // "./data/fgimage/foo.webp"
     */
