...
; ＞遊戯室（行けない）
[clickable x="510" y="180" width="140" height="35" target="*lock_yugisitu" color="red" opacity="30"]
[clickable x="365" y="215" width="285" height="75" target="*lock_yugisitu" color="red" opacity="30"]
...
; ===================================
*do_move
[jump storage="&tf.selected_room" target="*start3"]
