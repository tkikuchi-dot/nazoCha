...
[if exp="f.unlock_nazo_a == null"]

[eval exp="f.unlock_nazo_a = false"]

[endif]

[if exp="f.unlock_nazo_b == null"]

[eval exp="f.unlock_nazo_b = false"]

[endif]

[if exp="f.unlock_nazo_c == null"]

[eval exp="f.unlock_nazo_c = false"]

[endif]

[if exp="f.unlock_nazo_d == null"]

[eval exp="f.unlock_nazo_d = false"]

[endif]

[if exp="f.unlock_nazo_e == null"]

[eval exp="f.unlock_nazo_e = false"]

[endif]

[if exp="f.unlock_doc_1 == null"]

[eval exp="f.unlock_doc_1 = false"]

[endif]

[if exp="f.unlock_doc_2 == null"]

[eval exp="f.unlock_doc_2 = false"]

[endif]

[if exp="f.unlock_doc_3 == null"]

[eval exp="f.unlock_doc_3 = false"]

[endif]

[if exp="f.unlock_doc_4 == null"]

[eval exp="f.unlock_doc_4 = false"]

[endif]

[if exp="f.unlock_doc_5 == null"]

[eval exp="f.unlock_doc_5 = false"]

[endif]

[if exp="f.unlock_doc_6 == null"]

[eval exp="f.unlock_doc_6 = false"]

[endif]

[if exp="f.unlock_doc_7 == null"]

[eval exp="f.unlock_doc_7 = false"]

[endif]

[if exp="f.unlock_doc_8 == null"]

[eval exp="f.unlock_doc_8 = false"]

[endif]

[if exp="f.unlock_doc_9 == null"]

[eval exp="f.unlock_doc_9 = false"]

[endif]

[if exp="f.unlock_doc_10 == null"]

[eval exp="f.unlock_doc_10 = false"]

[endif]

[if exp="f.unlock_clue_1 == null"]

[eval exp="f.unlock_clue_1 = false"]

[endif]

[if exp="f.unlock_clue_2 == null"]

[eval exp="f.unlock_clue_2 = false"]

[endif]

[if exp="f.unlock_clue_3 == null"]

[eval exp="f.unlock_clue_3 = false"]

[endif]

[if exp="f.unlock_clue_4 == null"]

[eval exp="f.unlock_clue_4 = false"]

[endif]

[if exp="f.unlock_clue_5 == null"]

[eval exp="f.unlock_clue_5 = false"]

[endif]

[if exp="f.unlock_clue_6 == null"]

[eval exp="f.unlock_clue_6 = false"]

[endif]

[if exp="f.unlock_clue_7 == null"]

[eval exp="f.unlock_clue_7 = false"]

[endif]

[if exp="f.unlock_clue_8 == null"]

[eval exp="f.unlock_clue_8 = false"]

[endif]

[if exp="f.unlock_clue_9 == null"]

[eval exp="f.unlock_clue_9 = false"]

[endif]

[if exp="f.unlock_clue_10 == null"]

[eval exp="f.unlock_clue_10 = false"]
...
[call  storage="menu_data.ks"  target=""  ]
[iscript]
...
for (selected in (window.menuCluePages || {})) {
nums = window.menuGetPageNums(window.menuCluePages[selected]);
for (i = 0; i < nums.length; i++) {
k = "unlock_clue_" + selected + "_p" + nums[i];
if (f[k] == null) f[k] = false;
}
}
};
...
prefix = "unlock_clue_" + selected + "_p";
pages = (window.menuCluePages || {})[selected] || {};
} else {
...
window.menuApplyCluePage = function (selected, page) {
var tf = TYRANO.kag.variable.tf;
var pages = window.menuCluePages[selected] || {};
var unlocked = window.menuGetUnlockedPages("clue", selected);
var total = unlocked.length;
if (total < 1) {
tf.menu_clue_selected = selected;
tf.menu_clue_page = 1;
tf.menu_clue_page_total = 1;
tf.menu_clue_page_label = "1/1";
tf.menu_clue_title = "未開放";
tf.menu_clue_text1 = "この手がかりのページはまだ開放されていません。";
tf.menu_clue_text2 = "";
tf.menu_clue_img = "画像：未開放";
tf.menu_clue_image = "";
return;
}
if (unlocked.indexOf(page) < 0) page = unlocked[0];
var pos = unlocked.indexOf(page) + 1;
var data = pages[page] || pages[1] || window.makeCluePlaceholder("手がかり", 1);
tf.menu_clue_selected = selected;
tf.menu_clue_page = page;
tf.menu_clue_page_total = total;
tf.menu_clue_page_label = pos + "/" + total;
tf.menu_clue_title = data.title;
tf.menu_clue_text1 = data.text1;
tf.menu_clue_text2 = data.text2;
tf.menu_clue_img = data.img;
tf.menu_clue_image = data.image;
};
window.menuStepCluePage = function (delta) {
var tf = TYRANO.kag.variable.tf;
var unlocked = window.menuGetUnlockedPages("clue", tf.menu_clue_selected);
if (unlocked.length < 1) return;
var idx = unlocked.indexOf(tf.menu_clue_page);
if (idx < 0) idx = 0;
idx = (idx + delta + unlocked.length) % unlocked.length;
window.menuApplyCluePage(tf.menu_clue_selected, unlocked[idx]);
};
...
[jump  target="*nazo_a"  storage=""  ]
[else]

[jump  target="*set_nazo_default"  storage=""  ]
[endif]
...
root.find("[data-event-target^='*tab_'], [data-event-target^='*nazo_'], [data-event-target^='*doc_'], [data-event-target^='*clue_'], [data-event-target='*close']").remove();
...
[glink  color="btn_19_black"  text="手がかり"  x="520"  y="20"  size="22"  width="180"  height="56"  target="*tab_clue"  ]
...
[if exp="tf.menu_tab == 'clue'"]

[ptext name="menu_clue_header" layer="1" x="90" y="120" size="28" color="white" text="手がかり一覧" bold="true"]

[if exp="f.unlock_clue_1 == true"]

[glink  color="btn_19_black"  text="手がかり1"  x="90"  y="180"  size="18"  width="240"  height="44"  target="*clue_1"  ]
[else]

[ptext name="menu_clue_lock_1" layer="1" x="110" y="190" size="24" color="white" text="？？？"]

[endif]

[if exp="f.unlock_clue_2 == true"]

[glink  color="btn_19_black"  text="手がかり2"  x="90"  y="228"  size="18"  width="240"  height="44"  target="*clue_2"  ]
[else]

[ptext name="menu_clue_lock_2" layer="1" x="110" y="238" size="24" color="white" text="？？？"]

[endif]

[if exp="f.unlock_clue_3 == true"]

[glink  color="btn_19_black"  text="手がかり3"  x="90"  y="276"  size="18"  width="240"  height="44"  target="*clue_3"  ]
[else]

[ptext name="menu_clue_lock_3" layer="1" x="110" y="286" size="24" color="white" text="？？？"]

[endif]

[if exp="f.unlock_clue_4 == true"]

[glink  color="btn_19_black"  text="手がかり4"  x="90"  y="324"  size="18"  width="240"  height="44"  target="*clue_4"  ]
[else]

[ptext name="menu_clue_lock_4" layer="1" x="110" y="334" size="24" color="white" text="？？？"]

[endif]

[if exp="f.unlock_clue_5 == true"]

[glink  color="btn_19_black"  text="手がかり5"  x="90"  y="372"  size="18"  width="240"  height="44"  target="*clue_5"  ]
[else]

[ptext name="menu_clue_lock_5" layer="1" x="110" y="382" size="24" color="white" text="？？？"]

[endif]

[if exp="f.unlock_clue_6 == true"]

[glink  color="btn_19_black"  text="手がかり6"  x="90"  y="420"  size="18"  width="240"  height="44"  target="*clue_6"  ]
[else]

[ptext name="menu_clue_lock_6" layer="1" x="110" y="430" size="24" color="white" text="？？？"]

[endif]

[if exp="f.unlock_clue_7 == true"]

[glink  color="btn_19_black"  text="手がかり7"  x="90"  y="468"  size="18"  width="240"  height="44"  target="*clue_7"  ]
[else]

[ptext name="menu_clue_lock_7" layer="1" x="110" y="478" size="24" color="white" text="？？？"]

[endif]

[ptext name="menu_clue_title" layer="1" x="390" y="120" size="28" color="white" text="&'【' + tf.menu_clue_title + '】'" bold="true" overwrite="true"]

[if exp="tf.menu_clue_image != ''"]

[iscript]
var clueSrc = "./data/fgimage/" + TYRANO.kag.variable.tf.menu_clue_image;
window.menuSetPreviewImage(encodeURI(clueSrc).replace(/#/g, "%23"), 390, 170, 500, 280);
[endscript]

[else]

[ptext name="menu_clue_img_text" layer="1" x="390" y="170" size="24" color="white" text="&tf.menu_clue_img" bold="true" overwrite="true"]

[endif]

[ptext name="menu_clue_text1" layer="1" x="390" y="494" size="22" color="white" text="&tf.menu_clue_text1" overwrite="true"]

[ptext name="menu_clue_text2" layer="1" x="390" y="534" size="22" color="white" text="&tf.menu_clue_text2" overwrite="true"]

[if exp="tf.menu_clue_selected > 0"]

[ptext name="menu_clue_page" layer="1" x="836" y="124" size="22" width="94" align="center" color="white" text="&tf.menu_clue_page_label" overwrite="true"]

[if exp="tf.menu_clue_page_total > 1"]

[glink  color="btn_19_black"  text="◀"  x="780"  y="116"  size="20"  width="56"  height="44"  target="*clue_page_prev"  ]
[glink  color="btn_19_black"  text="▶"  x="930"  y="116"  size="20"  width="56"  height="44"  target="*clue_page_next"  ]
[endif]
...
return /^\*(tab_|nazo_|doc_|clue_|close)/.test(t || "");
};
...
root.find(".layer:visible").has("[name^='menu_'], [data-event-target^='*tab_'], [data-event-target^='*nazo_'], [data-event-target^='*doc_'], [data-event-target^='*clue_'], [data-event-target='*close']").each(function () {
...
[jump  target="*set_doc_default"  storage=""  ]
*tab_clue

[eval exp="tf.menu_tab = 'clue'"]

[jump  target="*set_clue_default"  storage=""  ]
...
[jump  target="*nazo_b"  storage=""  ]
[elsif exp="f.unlock_nazo_c == true"]

[jump  target="*nazo_c"  storage=""  ]
[elsif exp="f.unlock_nazo_d == true"]

[jump  target="*nazo_d"  storage=""  ]
[elsif exp="f.unlock_nazo_e == true"]

[jump  target="*nazo_e"  storage=""  ]
[else]
...
[jump  target="*refresh_menu"  storage=""  ]
[endif]
...
[jump  target="*doc_1"  storage=""  ]
[elsif exp="f.unlock_doc_2 == true"]

[jump  target="*doc_2"  storage=""  ]
[elsif exp="f.unlock_doc_3 == true"]

[jump  target="*doc_3"  storage=""  ]
[elsif exp="f.unlock_doc_4 == true"]

[jump  target="*doc_4"  storage=""  ]
[elsif exp="f.unlock_doc_5 == true"]

[jump  target="*doc_5"  storage=""  ]
[elsif exp="f.unlock_doc_6 == true"]

[jump  target="*doc_6"  storage=""  ]
[elsif exp="f.unlock_doc_7 == true"]

[jump  target="*doc_7"  storage=""  ]
[else]
...
[jump  target="*clue_1"  storage=""  ]
[elsif exp="f.unlock_clue_2 == true"]

[jump  target="*clue_2"  storage=""  ]
[elsif exp="f.unlock_clue_3 == true"]

[jump  target="*clue_3"  storage=""  ]
[elsif exp="f.unlock_clue_4 == true"]

[jump  target="*clue_4"  storage=""  ]
[elsif exp="f.unlock_clue_5 == true"]

[jump  target="*clue_5"  storage=""  ]
[elsif exp="f.unlock_clue_6 == true"]

[jump  target="*clue_6"  storage=""  ]
[elsif exp="f.unlock_clue_7 == true"]

[jump  target="*clue_7"  storage=""  ]
[else]

[eval exp="tf.menu_clue_selected = 0"]

[eval exp="tf.menu_clue_title = '未開放'"]

[eval exp="tf.menu_clue_text1 = '手がかりが未開放です。'"]

[eval exp="tf.menu_clue_text2 = ''"]

[eval exp="tf.menu_clue_img = '画像：未開放'"]

[eval exp="tf.menu_clue_image = ''"]

[eval exp="tf.menu_clue_page = 1"]

[eval exp="tf.menu_clue_page_total = 1"]

[eval exp="tf.menu_clue_page_label = '1/1'"]
...
[iscript]
window.menuApplyCluePage(7, 1);
[endscript]

[jump  target="*refresh_menu"  storage=""  ]
*clue_8

[if exp="f.unlock_clue_8 != true"]

[jump  target="*refresh_menu"  storage=""  ]
[endif]

[iscript]
window.menuApplyCluePage(8, 1);
[endscript]

[jump  target="*refresh_menu"  storage=""  ]
*clue_9

[if exp="f.unlock_clue_9 != true"]

[jump  target="*refresh_menu"  storage=""  ]
[endif]

[iscript]
window.menuApplyCluePage(9, 1);
[endscript]

[jump  target="*refresh_menu"  storage=""  ]
*clue_10

[if exp="f.unlock_clue_10 != true"]

[jump  target="*refresh_menu"  storage=""  ]
[endif]

[iscript]
window.menuApplyCluePage(10, 1);
[endscript]
